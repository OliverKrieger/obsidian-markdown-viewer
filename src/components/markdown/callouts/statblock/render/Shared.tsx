...
export function DiamondDivider() {
    return (
        <div className="flex items-center justify-center my-3">
            <div className="flex-1 h-px bg-linear-to-r from-transparent to-primary/50" />
            <div className="w-2 h-2 rotate-45 bg-primary mx-2" />
            <div className="flex-1 h-px bg-linear-to-l from-transparent to-primary/50" />
        </div>
    );
}
...
export function WildCardBadge() {
    return (
        <div className="absolute -top-3 -right-3 w-10 h-10 bg-accent rounded-full flex items-center justify-center shadow-md border-2 border-accent-foreground/20">
